...
public class SQLQueryConstant {
	...
	public static final String VIEW_REGISTER_COURSES_STUDENT="select Id,course_name,course_price from course where id=(select course_id from course_reg where student_id=?)"; 
